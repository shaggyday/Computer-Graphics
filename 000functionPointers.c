...
can return functions from functions. This feature helps us write programs that 
reconfigure their behavior at run time, if only a little. */
...
not really interested in what the function does. I'm just interested in its 
